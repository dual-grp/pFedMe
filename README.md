...
- CIFAR10:
    <pre><code>
    python3 main.py --dataset Cifar10 --model cnn --batch_size 20 --learning_rate 0.05 --personal_learning_rate 0.1 --beta 1 --lamda 10 --num_global_iters 600 --local_epochs 20 --algorithm pFedMe --numusers 5 --times 10
    </code></pre>

    <pre><code>
    python3 main.py --dataset Cifar10 --model cnn --batch_size 20 --learning_rate 0.05 --personal_learning_rate 0.1 --beta 0.5 --lamda 12 --num_global_iters 600 --local_epochs 20 --algorithm pFedMe --numusers 5 --times 10
    </code></pre>
